      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-8 md:gap-0 relative">
          ...
          {workflowSteps.map((step, index) => (
            <div key={step.number} className="relative z-10 flex-1 flex flex-col items-start mb-8 md:mb-0">
              ...
              <div className="text-gray-400 text-sm text-left">{step.description}</div>
            </div>
          ))}
        </div>
      </div>
