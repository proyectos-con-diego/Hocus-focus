      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Después de tu sesión puedes elegir el camino que más te convenga:
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 rounded-2xl p-8 text-center hover:border-emerald-500/30 transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Implementar por tu cuenta</h3>
            <p className="text-gray-400 mb-6">
              Ejecutas el roadmap con tu equipo interno. Tienes el documento detallado, el roadmap paso a paso y la grabación de la sesión como guía completa para implementar cada automatización.
            </p>
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-yellow-600/10 border border-amber-500/30 rounded-2xl p-8 text-center hover:border-amber-500/50 transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Plan Automate Starter Completo</h3>
            <p className="text-gray-400 mb-6">
              Implementamos juntos 3 automatizaciones en 6 semanas con acompañamiento completo, setup de todas las herramientas y training personalizado para tu equipo.
            </p>
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="px-12 py-5 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full font-black text-xl text-white shadow-2xl hover:scale-105 transition-all duration-300 hover:shadow-purple-500/40 uppercase tracking-wider"
          >
            🚀 Agendar diagnóstico
          </button>
